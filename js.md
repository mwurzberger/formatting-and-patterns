# Front End Coding and Frmatting

## Based in part off idomati.js (https://github.com/rwaldron/idiomatic.js)
...
1. <a name="namespace">Namespace</a>


2. <a name="whitespace">Whitespace</a>
  - Never mix spaces and tabs.
  - When beginning a project, before you write any code, choose between soft indents (spaces) or real tabs, consider this **law**.
  - For readability, I always recommend setting your editor's indent size to two characters &mdash; this means four spaces or four spaces representing a real tab.
...
6. <a name="practical">Practical Style</a>
